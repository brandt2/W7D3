...
/*!*********************************************!*\
  !*** ./frontend/actions/pokemon_actions.js ***!
  \*********************************************/
/*! exports provided: RECEIVE_ALL_POKEMON, receiveAllPokemon, requestPokemon */
...
var requestPokemon = function requestPokemon() {
  return function (dispatch) {
    ...
    $.ajax({
      ...
      var allPokemon = response;
      var action = receiveAllPokemon(allPokemon);
      dispatch(action);
    });
  };
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    getAllPokemon: function getAllPokemon() {
      return dispatch(requestPokemon());
    }
  };
};
